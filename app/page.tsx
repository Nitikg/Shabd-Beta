...
const COPY = {
  en: {
    headline: "Namaste! I'm Kiki",
    sub: "Your child's curious AI friend - tell me a story, ask me anything!",
    cta: "Start Talking",
    foot: "No login needed \u00b7 Free to try \u00b7 For ages 4-8",
    mic: "Kiki needs to hear your child's voice. Please allow microphone access.",
  },
  hi: {
    headline: "Namaste! \u092e\u0948\u0902 Kiki \u0939\u0942\u0901",
    sub: "\u092e\u0948\u0902 \u0906\u092a\u0915\u0947 \u092c\u091a\u094d\u091a\u0947 \u0915\u093e \u091c\u093f\u091c\u094d\u091e\u093e\u0938\u0941 AI \u0926\u094b\u0938\u094d\u0924 \u0939\u0942\u0901 - \u0915\u0939\u093e\u0928\u0940 \u0938\u0941\u0928\u093e\u0913, \u0915\u0941\u091b \u092d\u0940 \u092a\u0942\u091b\u094b!",
    cta: "Kiki \u0938\u0947 \u092c\u093e\u0924 \u0936\u0941\u0930\u0942 \u0915\u0930\u0947\u0902",
    foot: "\u0915\u094b\u0908 \u0932\u0949\u0917\u093f\u0928 \u0928\u0939\u0940\u0902 \u00b7 \u092e\u0941\u092b\u094d\u0924 \u00b7 \u0909\u092e\u094d\u0930 4-8",
    mic: "Kiki \u0915\u094b \u0906\u092a\u0915\u0947 \u092c\u091a\u094d\u091a\u0947 \u0915\u0940 \u0906\u0935\u093e\u091c\u093c \u0938\u0941\u0928\u0928\u0940 \u0939\u0948\u0964 \u0915\u0943\u092a\u092f\u093e \u092e\u093e\u0907\u0915\u094d\u0930\u094b\u092b\u094b\u0928 \u0915\u0940 \u0905\u0928\u0941\u092e\u0924\u093f \u0926\u0947\u0902\u0964",
  }
};

function detectLanguage(): 'en' | 'hi' {
  if (typeof window === 'undefined') return 'en';
  const saved = window.localStorage.getItem('kiki:lang');
    ...
    <main className="kiki-gradient-bg min-h-screen px-5 py-8">
      <div className="mx-auto flex max-w-md flex-col gap-6">
        <header className="flex items-center justify-between">
          <div className="font-[var(--font-baloo)] text-2xl tracking-tight text-kiki-indigo">Kiki</div>
          <div className="flex items-center gap-2 rounded-full bg-white/70 p-1 shadow-soft">
            <button
              ...
              className={`rounded-full px-3 py-1 text-sm font-[var(--font-nunito)] ${
                lang === 'en' ? 'bg-kiki-orange text-white' : 'text-kiki-indigo/70'
              }`}
            >
              EN
            </button>
            <button
              ...
              onClick={() => setLang('hi')}
              className={`rounded-full px-3 py-1 text-sm font-[var(--font-nunito)] ${
                lang === 'hi' ? 'bg-kiki-orange text-white' : 'text-kiki-indigo/70'
              }`}
            >
              {"\u0939\u093f\u0902\u0926\u0940"}
            </button>
        ...
        <div className="kiki-card px-5 py-6 text-center">
          <KikiCharacter state="idle" className="mb-3" />
          <div className="font-[var(--font-baloo)] text-2xl">{t.headline} {"\u2728"}</div>
          <div className="mt-2 font-[var(--font-nunito)] text-base text-kiki-indigo/80">{t.sub}</div>

          <button
            type="button"
            onClick={start}
            className="mt-5 w-full rounded-3xl bg-kiki-orange px-6 py-4 text-lg font-[var(--font-baloo)] text-white shadow-soft transition active:scale-[0.99]"
          >
            {t.cta} {"\ud83c\udf99"}
          </button>

          <div className="mt-3 text-xs font-[var(--font-nunito)] text-kiki-indigo/60">{t.foot}</div>
