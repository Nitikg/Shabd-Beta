...
export function FeedbackForm({
  ...
  return (
    <div className="mx-auto w-full max-w-md space-y-4">
      <div className="shabd-card px-5 py-4">
            ...
            return (
              <button
                ...
                className={`rounded-full px-3 py-2 text-sm font-[var(--font-nunito)] transition ${
                  on ? 'bg-shabd-teal/20 border border-shabd-teal/40' : 'bg-white/60 border border-white/60'
                }`}
              >
                {c.label}
              </button>
          ...
          {[4, 5, 6, 7, 8].map((age) => (
            <button
              ...
              className={`rounded-2xl py-2 text-center font-[var(--font-nunito)] ${
                childAge === age ? 'bg-shabd-orange text-white' : 'bg-white/70 text-shabd-indigo/80'
              }`}
            >
              {age}
            </button>
      ...
      <div className="shabd-card px-5 py-4">
        ...
        <textarea
          ...
          className="mt-2 w-full rounded-2xl border border-white/70 bg-white/70 p-3 font-[var(--font-nunito)] outline-none focus:ring-2 focus:ring-shabd-purple/40"
          rows={4}
      ...
      <button
        ...
        onClick={submit}
        disabled={submitting}
        className="w-full rounded-3xl bg-shabd-orange px-6 py-4 text-lg font-[var(--font-baloo)] text-white shadow-soft transition active:scale-[0.99] disabled:opacity-60"
      >
